...
public class Manager {
    ...
    public static void main(String[] args) throws Exception{
        ...
        ConsumersQueueTeller standingLineConsumers = new ConsumersQueueTeller(countConsumers);
        ...
        CashRegister cashRegister = new CashRegister(observables, productsDataBaseOfSeller, delayProducts);
